...
class Params:
    '''defence rules'''
    defence: str = 'mitigation-pruning'  # mediod-distillation, ensemble-distillation, robustlr, finetuning , certified-robustness
    '''task and model'''
    ...
    model_similarity_factor: float = 0.0  # 0.0
