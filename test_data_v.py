...
if __name__ == "__main__":
    ...
    print(len(imgs_cifar10_train), len(labels_cifar10_train), len(label_names_cifar10))
    # random_visualize(imgs=imgs_cifar10_train,labels=labels_cifar10_train,label_names=label_names_cifar10)
